...
## v1.x — Stability & Privacy Flow Improvements (Mar–Apr 2026)

- Reliability fixes across transaction lifecycle.
- Better handling for edge cases and retries.
- Iterative UX refinements and transfer-flow simplification.
